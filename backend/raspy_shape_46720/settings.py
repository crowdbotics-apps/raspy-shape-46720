"""
Django settings for raspy_shape_46720 project.
...
ROOT_URLCONF = 'raspy_shape_46720.urls'
...
WSGI_APPLICATION = 'raspy_shape_46720.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "raspy_shape_46720 API",
    "DESCRIPTION": "API documentation for raspy_shape_46720 App",
    "VERSION": "v1",
}
